...
render_views
    ...
    describe "for signed-in users" do
      ...
      it "should have an element for each user" do
       ...
       it "should paginate users" do
         ...
         response.should have_selector("li.prev.previous_page.disabled", :content => "Previous")
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "Foo Bar", :email => "foo@bar.org",
                  :password => "foobar", :password_confirmation => "foobar" }
      end
  ...
  describe "authentication of edit/update pages" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        wrong_user = FactoryGirl.create(:user, :email => "foo@bar.net")
